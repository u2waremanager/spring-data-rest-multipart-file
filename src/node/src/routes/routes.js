export default [
    ...
    //     name: 'c1',
    //     meta: { title: ''},
    //     component: () => import(/* webpackChunkName: "Multipart" */ '../apps/C1.vue'), 
    // },
    // {
    //     path: '/multipart',
    //     name: 'c2',
    //     meta: { title: ''},
    //     component: () => import(/* webpackChunkName: "Multipart" */ '../apps/C2.vue'), 
    // },
    // {
    //     path: '/:backend/multipart',
    //     name: 'c3',
    //     meta: { title: ''},
    //     component: () => import(/* webpackChunkName: "Multipart" */ '../apps/C3.vue'), 
    // },
    // {
    //     path: '/:rest/browser',
    //     name: 'c4',
    //     meta: { title: ''},
    //     component: () => import(/* webpackChunkName: "Multipart" */ '../apps/C4.vue'), 
    // },
